...
const LoadingIcon = ({ isLoading }) => {
    let display = isLoading ? '' : 'none'

    return (
        <div>
            <div className="_4emnV" style={{display: display}}>
                <div className=" Igw0E IwRSH YBx95 _4EzTm _9qQ0O ZUqME" style={{ height: "32px", width: "32px" }}>
                    <svg aria-label="읽어들이는 중..." className=" By4nA" viewBox="0 0 100 100">
